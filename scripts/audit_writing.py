...
def _load_checks() -> list[Check]:
    ...
    checks = [
        ...
        Check("Baseline cross mean (3-seed cells)", 0.445, "transfer_cell_mean_std default"),
        Check("Baseline cross std avg", 0.057, "transfer_cell_mean_std default"),
        Check("Strong cross mean (partial seeds)", 0.502, "transfer_cell_mean_std strong"),
        Check("Wilcoxon aug p (18 cells)", 0.0077, "stats_tests.csv"),
        Check("Mean paired aug delta", 0.063, "stats_tests.csv"),
